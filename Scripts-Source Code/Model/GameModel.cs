...
public class GameModel : MonoBehaviour {
    ...
    {
		using (System.IO.StreamWriter file = new System.IO.StreamWriter (@"C:\Users\Connor\Desktop\StoryDeckLog.txt", true))
    ...
    {
		using (System.IO.StreamWriter file = new System.IO.StreamWriter (@"C:\Users\Connor\Desktop\AdventureDeckLog.txt", true))
    ...
    public void DealAdventureCard(int player)
    {
		if (adventureDeck.Count == 0) {
			using (System.IO.StreamWriter file = new System.IO.StreamWriter (@"C:\Users\Connor\Desktop\MyLog.txt", true))
